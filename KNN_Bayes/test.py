...
class TestRunner:
    ...
    def run(self):
        test_suite = TestSuite(tests=[
            makeSuite(TestHamming),
            makeSuite(TestSortTrainLabelsKNN),
            makeSuite(TestPYXKNN),
            makeSuite(TestClassificationError),
            makeSuite(TestModelSelectionKNN),
            makeSuite(TestEstimateAPrioriNB),
            makeSuite(TestEstimatePXYNB),
            makeSuite(TestPYXNB),
            makeSuite(TestModelSelectionNB),
        ])
